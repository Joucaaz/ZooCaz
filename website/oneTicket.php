    ...
    <nav id="navmenu" style=" animation: fadeIn 3s;">
        <ul id="ulMenu">
            ...
            if(isset($_SESSION["email"]) && ($_SESSION["email"] == 'joudynho@free.fr' || $_SESSION["email"] == 'romuald.grignon@cyu.fr')){
                ...
                echo("<li id=\"lichooseticketMenu\"><a href=\"oneTicket.php\" style=\"text-decoration:none\" id=\"oneTMenu\" class=\"menu activeMenu\">Choose ticket</a></li>");
...
<form method="post" action="oneTicket.php" class="formTicket">
...
// show a specific ticket and change the status if the admin want
...
function oneTicket(){
    ...
    <form method="post" action="modifierTicket.php" class="formTicket">
        ...
        <button name="submit" type="submit" id="submit" class="btn btn-primary">Change</button>
    </form>
